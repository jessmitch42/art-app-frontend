...
const About = (props) => {
  ...
  return (
    <div className="about-container wrapper">
      ...
      <p><span className="about-page__quote">Women artists have been the subject of varying degrees of critical attention and neglect throughout history; as recently as the mid-20th century they have been the subject of outright derision in and exclusion from seminal art historical texts... Women have continued the struggle for recognition in modern and contemporary art spheres, to such an extent that feminist collective Guerilla Girls asked in 1989, “Do women have to be naked to get into the Met[ropolitan] Museum?” - <a href="https://www.artsy.net/gene/women-artists">Artsy</a> </span>
      </p>
